...
export const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-12 sm:space-y-20 md:space-y-28 pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-5 sm:space-y-7 flex flex-col justify-center text-left max-w-xl lg:max-w-none mx-auto lg:mx-0">
              ...
              <motion.div
                ...
                className="w-fit inline-flex items-center gap-1.5 sm:gap-2 px-3.5 py-1.5 rounded-full bg-cream-50 border border-gold-600/30 text-[8.5px] sm:text-[10px] text-gold-700 uppercase tracking-[0.18em] sm:tracking-[0.25em] font-semibold shadow-sm"
              >
      ...
      {/* CATEGORY PREVIEW - Immediately After Hero Section */}
      <section className="bg-cream-200/80 py-10 sm:py-16 border-b border-beige-200">
      ...
      {/* FEATURED PRODUCTS */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-10 pt-4 sm:pt-8">
